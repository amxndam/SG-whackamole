...
class TheScene extends THREE.Scene {
  ...
  createCamera (renderer) {
    ...
    this.camera.position.set (10, 30, 140);
  ...
  colisionObjetos () {
    ...
    var colMazo = new THREE.Box3().setFromObject(this.mazo);

    var colTopo1 = new THREE.Box3().setFromObject(this.topo1);
    var colision1 = colMazo.isIntersectionBox(colTopo1);
 
    var colTopo2 = new THREE.Box3().setFromObject(this.topo2);
    var colision2 = colMazo.isIntersectionBox(colTopo2);
 
    var colTopo3 = new THREE.Box3().setFromObject(this.topo3);
    var colision3 = colMazo.isIntersectionBox(colTopo3);
   
    var colTopo4 = new THREE.Box3().setFromObject(this.topo4);
    var colision4 = colMazo.isIntersectionBox(colTopo4);
    
    var colTopo5 = new THREE.Box3().setFromObject(this.topo5);
    var colision5 = colMazo.isIntersectionBox(colTopo5);

      if(colision1 && colision2 && colision3 && colision4 && colision5)
        return true;
...
*/
  ...
  animate () {
    ...
    var col = this.colisionObjetos()

    this.mazo.update(col);
