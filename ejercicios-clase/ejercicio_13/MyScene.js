  ...
  onKeyDown(event){
    ...
    if(this.directions[38] == true){
      if(this.directions[37] == true){
        document.getElementById("arrow").innerHTML = "&#8593 &#8592";
        this.car.update("goLeft");

      }

      else if(this.directions[39] == true){
        document.getElementById("arrow").innerHTML = "&#8593 &#8594";
        ...
        document.getElementById("arrow").innerHTML = "&#8593";
        this.car.update("go");
      }
    }
    ...
    /*Todo lo que vaya hacia atras*/
      ...
      if(this.directions[37] == true){
        document.getElementById("arrow").innerHTML = "&#8595 &#8592";
        this.car.update("backLeft");

      }

      else if(this.directions[39] == true){
        document.getElementById("arrow").innerHTML = "&#8595 &#8594";
        this.car.update("backRight");

      }

      else if(this.directions[37] == false & this.directions[39] == false){
        document.getElementById("arrow").innerHTML = "&#8595";
