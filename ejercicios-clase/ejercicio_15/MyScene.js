...
class MyScene extends THREE.Scene {
  ...
  createCamera () {
    ...
    this.cameraUp = new THREE.PerspectiveCamera(45, window.innerWidth/window.innerHeight, 0.1,1000);
    this.cameraUp.position.set(0,60,0);

    var look = new THREE.Vector3 (0,0,0);
    this.cameraUp.lookAt(look);
    this.add (this.cameraUp);

    var aspectRatio = window.innerWidth/window.innerHeight;

    this.cameraOrthographic = new THREE.OrthographicCamera(-aspectRatio*20/2, aspectRatio*20/2, aspectRatio*20/2, -aspectRatio*20/2, 1, 1000 );
    this.cameraOrthographic.position.set(20,20,20);

    var look = new THREE.Vector3 (0,0,0);
    this.cameraOrthographic.lookAt(look);
  ...
  renderViewports(escena, camara, left, top, width, height){
  ...
  update () {
    ...
    this.renderViewports(this, this.camera, 0,0.5,0.5,0.5);
    this.renderViewports(this, this.car.getCamera(), 0,0,0.5,0.5);
    this.renderViewports(this,this.cameraUp,0.5,0.5,0.5,0.5);
    this.renderViewports(this,this.cameraOrthographic,0.5,0,0.5,0.5);
  ...
  onKeyDown(event){
    ...
    if(this.directions[38] == true){
      if(this.directions[37] == true){
        this.car.update("goLeft");

      }

      else if(this.directions[39] == true){
        this.car.update("goRight");
    ...
    /*Todo lo que vaya hacia atras*/
      ...
      if(this.directions[37] == true){
        this.car.update("backLeft");

      }

      else if(this.directions[39] == true){
        this.car.update("backRight");

      }

      else if(this.directions[37] == false & this.directions[39] == false){
        this.car.update("back");
