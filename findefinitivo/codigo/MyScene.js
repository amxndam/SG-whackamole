...
class MyScene extends THREE.Scene {
  ...
  createLights () {
    ...
    this.spotLight1 = new THREE.SpotLight( 0xeb8934 );
    this.spotLight1.position.set( -500,60, 40  );
    this.add (this.spotLight1);

    //Luz en la caja de tono rosa
    this.spotLight3 = new THREE.SpotLight( 0xeb8934 );
    this.spotLight3.position.set( 500,60, 40  );
  ...
  createModel () {
    ...
    this.add(this.topo1);
    this.model.add(this.topo1);

    this.topo2 = new Topo( 1, 0, -10);
    this.add (this.topo2);
    this.model.add(this.topo2);

    this.topo3 = new Topo( -33, 0, -10);
    this.add (this.topo3);
    this.model.add(this.topo3);

    this.topo4 = new Topo( -16, 0, 11);
    this.add (this.topo4);
    this.model.add(this.topo4);

    this.topo5 = new Topo( 16, 0, 11);
    this.add (this.topo5);
    this.model.add(this.topo5);
